...
const PRINCIPLES = [
  {
    ...
    text: "AI загвар ангийн компьютер дээр ажиллаж, дүрсийг тэнд нь шинжилнэ. Видео, зураг интернэтээр хаашаа ч илгээгдэхгүй. Мэдэгдэлд харуулах зураг програм хаагдахад устгагдана.",
  },
  {
    icon: ScanFace,
    title: "Нүүр танихгүй",
...
const STORED = [
  "Мэдэгдлийн цаг, төрөл (жишээ нь: 09:34 — утас)",
  "Таны програмын тохиргоо",
  "Мэдэгдэл дээр дарж харах зураг — зөвхөн програм ажиллаж байх үед, хаагдахад автоматаар устна",
];
const NEVER_STORED = [
  "Видео бичлэг",
  "Сурагчийн зураг програм хаагдсаны дараа",
