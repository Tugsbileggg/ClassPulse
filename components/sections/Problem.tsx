...
import { Hourglass, Smartphone, Users } from "lucide-react";
...
const PROBLEMS = [
  {
    ...
    text: "Самбар дээр бичиж, асуултад хариулж байх зуур арын эгнээнд юу болж байгааг нэгэн зэрэг хянах аргагүй.",
  },
  {
    icon: Smartphone,
    title: "Ширээн доорх утас харагддаггүй",
    text: "Ширээн доор, номын ард нуусан утсыг багш ангийн урдаас харж амжихгүй. Сурагч хичээлээс аажмаар хөндийрнө.",
  },
  {
    icon: Hourglass,
    title: "Нойрмоглосон сурагч хоцорно",
    text: "Хичээлийн гол хэсгийг алгасаж нойрмоглосон сурагч дараа нь нөхөж амждаггүй. Үүнийг ихэнхдээ шалгалтын дүнгээс л мэддэг.",
  },
];
