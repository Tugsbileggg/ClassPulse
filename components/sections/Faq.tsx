...
const FAQS = [
  {
    question: "AI загварыг хаанаас татаж авах вэ?",
    answer:
      "Туршилтын хувилбар Windows болон Mac-д зориулж бэлэн боллоо. Энэ хуудасны «Татаж авах» хэсгээс компьютерийнхээ товчийг дарж татаад, zip доторх «Заавар.txt»-ийн дагуу суулгана.",
  },
  {
  ...
  },
  {
    ...
    answer:
      "Windows 10, 11 (64-bit) болон Apple Silicon процессортой Mac (macOS 14 эсвэл шинэ) дээр ажиллана. Санах ой болон бусад шаардлагыг «Татаж авах» хэсгээс харна уу.",
  },
  {
    question: "Видео интернэтээр явах уу?",
    answer:
      "Үгүй. Дүрсийн шинжилгээ бүхэлдээ таны компьютер дээр явагддаг тул видео, зураг интернэтээр хаашаа ч илгээгдэхгүй. Мэдэгдэл дээр дарж харах зураг зөвхөн програм ажиллаж байх үед түр хадгалагдаж, програм хаагдахад устгагдана. Компьютер дээр зөвхөн мэдэгдлийн цаг, төрөл зэрэг товч тэмдэглэл үлдэнэ.",
  },
  {
