...
const AUDIENCES = [
  {
    icon: GraduationCap,
    title: "Ангийн багш",
    text: "Хичээлийн үеэр хэнд анхаарал хэрэгтэйг шууд мэдэж, сурагч бүрийн оролцоог тоо баримтаар хянана.",
    points: [
      "Сатаарсан сурагчид цаг алдалгүй анхаарал хандуулна",
      "Эцэг эхтэй бодит мэдээлэлд тулгуурлан ярилцана",
      "Хичээлийн аль хэсэгт анги идэвх алдсаныг олж харна",
    ],
    accent: "bg-brand-600",
  },
  {
    ...
    text: "Анги, хичээл бүрийн оролцооны ерөнхий дүр зургийг харж, багш нартаа хэрэгтэй дэмжлэгийг цаг тухайд нь үзүүлнэ.",
    points: [
      "Ангиудын оролцооны чиг хандлагыг харьцуулна",
      "Сургалтын чанарын шийдвэрийг өгөгдөлд тулгуурлан гаргана",
      "Нууцлалын журмыг ClassPulse-тэй хамтран тогтооно",
    ],
